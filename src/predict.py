...
def decode(indices):
    ...
    # CHANGED: "".join -> " ".join. With a token-level
    # vocab, each element of `prediction` is a whole symbol
    # (e.g. "\frac", not "f"), so it needs a separator from
    # its neighbors -- matching train_labels.txt's format.
...
def ctc_prefix_beam_search(
    ...
    # CHANGED: "".join -> " ".join, same reasoning as decode().
